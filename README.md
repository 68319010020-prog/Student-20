...
ฟีเจอร์: สมัคร/เข้าสู่ระบบ, เพิ่ม/แก้ไข/ลบงาน, ค้นหา, กรองสถานะ, วันกำหนดส่ง, โน้ต และสรุปความคืบหน้า ข้อมูล SQLite ถูกเก็บใน Docker volume จึงอยู่ต่อหลัง redeploy และงานของแต่ละบัญชีแยกจากกัน
