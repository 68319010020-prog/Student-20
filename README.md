...
ฟีเจอร์: เพิ่ม/แก้ไข/ลบงาน, ค้นหา, กรองสถานะ, วันกำหนดส่ง, โน้ต และสรุปความคืบหน้า ข้อมูล SQLite ถูกเก็บใน Docker volume จึงอยู่ต่อหลัง redeploy
...
2. ตรวจว่าพอร์ต `30020` ไม่ชนกับคนอื่น โดยดู `docker ps` บน VPS
3. Push ไป branch `main`
4. เปิด `http://202.29.231.188:30020`
