...
4. กด `สร้างบัญชีใหม่` แล้วตั้งชื่อผู้ใช้ 3-30 ตัวอักษรและรหัสผ่านอย่างน้อย 6 ตัวอักษร
5. เพิ่มงานได้ทันทีและข้อมูลจะถูกเก็บไว้ใน SQLite ในโฟลเดอร์ `data/`
...
หรือสำหรับ local dev แบบไม่ใช้ Docker:
