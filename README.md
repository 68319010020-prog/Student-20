...
1. สมัครหรือเข้าสู่ระบบด้วยบัญชีเดโม่หรือบัญชีใหม่
2. คลิก `เพิ่มงานใหม่` เพื่อสร้างงาน
3. กรอกชื่องาน วิชา วันส่ง ความสำคัญ และโน้ตเพิ่มเติม
4. ใช้แผงกรองเงื่อนไขเพื่อดูงานตามสถานะหรือค้นหา
5. ใช้ `Export CSV` เพื่อดาวน์โหลดไฟล์งานเป็น CSV
6. เปลี่ยนไปที่ `Calendar` เพื่อดูงานตามวันส่งแบบเดือน
7. ลากงานใน List mode เพื่อจัดเรียงงานแบบคลิกและลาก
